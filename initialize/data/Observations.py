...
class Observations(Component):
  ...
  variablesWithDefaults = {
    ...
    ## CRTM
    # Project CRTM coefficients. The jcsda_internal set has no GOCART variants,
    # so the GOCART2G AOD operator fails with "Error initializing CRTM" when it
    # requests AerosolCoeff.GOCART-GEOS5.nc4. Both reference experiments use this.
